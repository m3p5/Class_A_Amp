...
More recently, I decided to implement this method in Python on my **TI-84 Plus CE Python** edition graphing calculator. It seemed like a good way to test out the Python programming capabilities of this calculator. And now that I have a working version, I decided to make it available for anyone that might be interested.
